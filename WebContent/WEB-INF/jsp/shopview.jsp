	...
	<div class="itemContainer">
		<c:forEach var="item" items="${itemList}">
		     <div class="item"> 
		     	...
		     	<img src="<c:url value="/resources/pic/pokeball_pic.png" />" height="50" width="50" />
		     	<label class="price"> ${item.getPrice() } </label>
		     	<img src="<c:url value="/resources/pic/money_pic.png" />" height="50" width="50" />
		     	<a href="paymentPage.html?item=${item.getId() }" class="buyButton"> <button class="btn btn-default" >  BUY </button> </a>
		     </div>         
		</c:forEach>
	</div>
